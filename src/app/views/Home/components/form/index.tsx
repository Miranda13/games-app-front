...
const Form = (props: PropsForm) => {
  ...
  const validateForm = (values: NewGame) => {
    ...
    if (!values.teamA || !values.teamB) {
      errors.push('Elige dos equipos')
    }

    if (!values.location) {
      errors.push('Elige una ubicacion')
    }
    ...
    if (+values.scoreB > 500 || +values.scoreA > 500 || +values.scoreB < 0 || +values.scoreA < 0) {
      errors.push('El rango de goles permitido es de 0 a 500')
    }
  ...
  return (
    <article className='fixed top-[10%] sm:top-[12%] left-[5%] sm:left-[15%] md:[20%] lg:left-[30%] w-full max-w-md bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 p-6 flex flex-col m-2'>
      ...
      <form onSubmit={handleSubmit}>
        <div className='flex flex-wrap gap-x-10 justify-center'>
          <div className='flex flex-col w-[40%] items-center'>
            ...
            <select
              name='teamA' 
              id='teams' onChange={handleChange}
              defaultValue=''
          ...
          <div className='flex flex-col items-center'>
            ...
            <input name='scoreB' type='number' id='score_two' onChange={handleChange} className='bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-12 p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500' placeholder='0' required/>
          </div>
        </div>
